...
public class TriangleTest {
    ...
    static {
        logger = LoggerFactory.getLogger(String.valueOf(TriangleTest.class));
    }
    ...
    public class WithArrangeCreatingTriangleTest {
        ...
        void paintInAllPossibleColoursTest() {
            paintInAllPossibleColoursTest();
        }
    ...
    void triangleAreaTest()
    {
        ...
        int actualResult = triangle.calculatetriangleArea(); // Act
        assertEquals(6, actualResult); //Assert
    }
}
